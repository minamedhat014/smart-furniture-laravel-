...
<x-app-modal id="addModal" type="store" title="Add customer">
  <x-slot name="inputs">
    ...
    <x-form-input  type="date" fname="Date of birth" bname="date_of_birth" icon="fa-solid fa-calendar"/>
    <x-form-input  type="date" fname="Date of marriage" bname="date_of_marriage" icon="fa-solid fa-calendar"/>
