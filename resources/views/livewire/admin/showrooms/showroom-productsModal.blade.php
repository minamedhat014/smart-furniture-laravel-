...
<x-app-modal id="AddshowProductModal" type="store" title="Add product to showroom ">
  <x-slot name="inputs">
    <x-form-select  fname=" Product name"  display="name" :options="$products" bname="product_id" icon="fa-brands fa-product-hunt" value="id" />
    <x-form-input type="text" fname=" Quantity"  bname="quantity" icon="fa-solid fa-hashtag"/>
