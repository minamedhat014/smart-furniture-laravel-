...
<x-app-modal id="AddNewStaffModal" type="store" title="Add new member to staff  branch">
  ...
  <x-slot name="inputs">
    <x-form-input type="text" fname=" Emplyee name"  bname="sales_name" icon="fa-solid fa-user-tie"/>
    <x-form-select  fname="Title"  display="name"  :options="[['id' => 1, 'name' => 'designer'],['id' => 0, 'name' => 'sales'],['id' => 2, 'name' => 'branch manager'],['id' => 3, 'name' => 'area sales manager']]" bname="title" icon="fa-solid fa-building" value="id" />
